...
func update_item(_item_name: String, _type: String ) -> void:
	match _type:
		"increase":
			_inventory_aux["item_name"]["item_amount"] += 1
			get_tree().call_group("fridge_container", "update_character", "update", _inventory_aux["item_name"])
			get_tree().call_group("oven_container", "update_character", "update", _inventory_aux["item_name"])
			get_tree().call_group("cutting_container", "update_character", "update", _inventory_aux["item_name"])
		"decrease":
			_inventory_aux["item_name"]["item_amount"] -= 1
			get_tree().call_group("fridge_container", "update_character", "update", _inventory_aux["item_name"], "decrease")
			get_tree().call_group("oven_container", "update_character", "update", _inventory_aux["item_name"],"decrease")
			get_tree().call_group("cutting_container", "update_character", "update", _inventory_aux["item_name"],"decrease")
			
			if _inventory_aux["item_name"]["item_amount"] == 0:
